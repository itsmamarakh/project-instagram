        ...
        <div className="flex items-center h-full justify-between container mx-auto max-w-screen-lg relative">
          ...
          <div className="w-60">
            <div>
              <input
                ...
                type="text"
                className="bg-[#EFEFEF] searchText text-gray-900 outline-none text-sm rounded-sm w-full px-4 py-2"
                placeholder="Search..."
              />
            </div>
            {focused && (
          ...
          <div>
            <div className="flex">
              {user ? (
                <>
                  <div className="p-2 mt-6 mr-2 h-90 text-black" >
                    <Link to="/">
                    <SlHome className="text-[1.8rem] icon" />
                    </Link>
                  ...
                  >
                    <div></div>
                    <div className="mt-5 mr-2 text-black">
                      {/* <SquarePlus /> */}
                      <MdOutlineAddBox className="text-[1.8rem] icon" />
                    </div>

                    <div className="mt-4 cursor-pointer flex items-center justify-center  text-black">
                      <button
                        type="button"
                        title="Sign Out"
                      ...
                      >
                        {/* <SignOut /> */}
                        <MdLogout className="text-[1.8rem] icon" />
                      </button>
                    </div>
                  </div>
                  <div
                    className="mt-7 rounded-full border-2 p-0.5 border-red-600 cursor-pointerflex items-center justify-center w-8 h-8 relative select-none"
