  ...
  return (
    <div className="grid grid-cols-3 gap-4 justify-between mx-auto max-w-screen-lg mt-4">
      <div className="container items-center flex justify-center">
        {avatarSrc ? (
          <div className="rounded-full border-2 border-red-600 p-1 items-center flex justify-center w-[10rem] h-[10rem]">
            <img
              className="p-[1px] m-1 rounded-full w-full h-full flex object-cover"
