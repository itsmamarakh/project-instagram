...
const EditUserPage = () => {
  ...
  return (
    ...
    <div className="mt-6 flex justify-center bg-secondary ">
      ...
      <div className="border-2xl shadow-2xl flex mt-20  flex-col p-4 rounded bg-black" >
        <div className="flex items-center mt-4 mb-4 justify-end " >
          ...
          <div className="mb-2 flex-auto w-60 ml-4">
            <div>
              <span className="mb-2 text-xl text-white">{user.displayName}</span>
            </div>
            <div
        ...
        <div className="flex items-center my-3 w-full">
          <div className="border-b-[1px] border-black h-0 w-full">
          </div>
        </div>
